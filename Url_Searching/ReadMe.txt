...
Url Searching:
Since I had an ambiguity if you are looking for just tweeted tweets or tweets from the time you run the program, I wrote two source code for either cases.
